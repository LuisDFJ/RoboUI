...
class RGLWidget( QtWidgets.QOpenGLWidget ):
    ...
    def initializeGL(self):
        ...
        self.link_1 = RSolid(
            r".\RMedia\link1_completo.obj",
            self.engine, 
            100, 
            np.array( [-0.241, -0.1436, 0.0] ),
        ...
        self.link_2 = RSolid( 
            r".\RMedia\link2_completo.obj", 
            self.engine, 
            100, 
            np.array( [-0.1457, -0.12, -0.2412]),
            color= np.array( [ 0.3, 0.3, 0.3 ] )
        ) 
        self.link_3 = RSolid( 
            r".\RMedia\link3_completo.obj", 
            self.engine, 
            100, 
            np.array( [-0.1457, -0.12, -0.2412] ),
